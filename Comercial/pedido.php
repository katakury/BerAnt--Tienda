        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <img class="img-responsive center-all-contens" src="assets/img/ber.jpeg" style="opacity: .4">
                </div>
                <div class="col-xs-12 col-sm-6">
                    <div id="form-compra">
                                ...
                                if(!$_SESSION['nombreUser']=="" &&!$_SESSION['claveUser']==""){
                                    ...
                                    echo '
                                        ...
                                        <p>
                                            ...
                                            y contraseña con la cual te registraste en <span class="tittles-pages-logo">BerAnt</span>.
                                        </p>
                                        <br>
